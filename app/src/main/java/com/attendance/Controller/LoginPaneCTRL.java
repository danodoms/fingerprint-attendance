...
public class LoginPaneCTRL implements Initializable {
    ...
    String fpAnimationImagePath = "/app/src/main/java/org/attendance/Images/fp_scan_animation.gif";
    String fpImagePath = "/app/src/main/java/org/attendance/Images/fp_placeholder.jpg";
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        togglePassVisibilityImageView.setOnMouseClicked(event -> {
            if (showPassword) {
                togglePassVisibilityImageView.setImage(new Image("/app/src/main/java/org/attendance/Images/hide_password.png"));
                ...
                togglePassVisibilityImageView.setImage(new Image("/app/src/main/java/org/attendance/Images/show_password.png"));
